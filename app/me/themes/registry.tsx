...
const THEMES: Record<string, ThemeConfig> = {
  ...
  "eiszauber": {
    colors: {
      ...
      gradient:    "linear-gradient(135deg, #f0006e, #a8004d)",
      card:    { background: "rgba(255,250,254,0.95)", border: "1px solid rgba(240,0,110,.18)" },
      sub:     { background: "#fff7fb", border: "1px solid rgba(240,0,110,.18)" },
      input:   { background: "#fff7fb", border: "1px solid rgba(240,0,110,.35)", color: "#2c1020" },
      badge:   { background: "#ffd6e9", border: "1px solid #f0006e88", color: "#a8004d" },
