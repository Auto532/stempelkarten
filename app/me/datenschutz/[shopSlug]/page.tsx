    ...
    <div className={`min-h-screen px-5 pt-10 pb-16 max-w-sm mx-auto relative ${isVintage || isGrill ? "z-[2]" : ""}`}>
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="relative z-10">
        ...
        <div className="mb-8">
          ...
          <div className="mt-2 h-px" style={{ background: isGrill ? "linear-gradient(to right, #E07A2066, transparent)" : isVintage ? "linear-gradient(to right, #C49A2A66, transparent)" : "linear-gradient(to right, rgba(251,191,36,0.4), transparent)" }} />
        </div>
